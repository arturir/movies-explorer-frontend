    ...
    return (
        <>
            ...
            <main className="profile">
                ...
                <div className="profile__row profile__row_with-bottom-line"><p className="profile__text">Имя</p><p className="profile__text">{userName}</p></div>

                <div className="profile__row"><p className="profile__text">E-mail</p><p className="profile__text">{email}</p></div>
