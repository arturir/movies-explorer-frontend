    ...
    return (
        <nav className={themeHeaderIsBlue ? "menu menu_theme_blue" : "menu"}>  
            <div className="menu__wrapper">
                ...
                <div className={loggedIn ? "menu__burger-link" : "menu__burger-link menu__burger-link_no-loggedin"} onClick={toggleBurgerMenu}>
                    <div className={themeHeaderIsBlue ? "menu__burger menu__burger_theme_blue" : "menu__burger"}></div>
                </div>
                {!loggedIn && <div className={"menu__links-register"}>
