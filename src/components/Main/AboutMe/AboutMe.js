        ...
        <section className="about-me" id="about-me">
            <div className="about-me__wrapper">
                ...
                <div className="about-me__wrapper-about">
                    <img src={require("../../../images/student.jpg")} className="about-me__photo" alt="Фотография студента" />
                    <div className="about-me__left-column">
                        ...
                        <Link to="https://github.com/arturir/" target="_blank" className="about-me__github-link">Github</Link>
                    </div>
                </div>
            </div>
        </section>
